...
<main class="program-detail" style="--program-accent: <?php echo esc_attr($accent); ?>; --program-soft: <?php echo esc_attr($soft); ?>; --program-navy: <?php echo esc_attr($navy); ?>;">
    <style>
        ...
        @media (min-width:1024px){.program-detail__sidebar{position:sticky;top:var(--site-header-offset,108px)}}
        ...
        @media (max-width:767px){.program-detail__hero{padding:28px 0 38px}.program-detail__hero::after{background-image:radial-gradient(circle at 78% 86%,rgba(255,255,255,.10) 0%,rgba(255,255,255,0) 34%),linear-gradient(135deg,#141943 0%,#1c275b 52%,#243774 100%)}.program-detail__hero-grid{min-height:auto}.program-detail__title{font-size:clamp(2.05rem,10vw,3.05rem)}.program-detail__summary{font-size:.95rem}.program-detail__button{width:100%}.program-detail__cards,.program-detail__outcomes,.program-detail__related{grid-template-columns:1fr}.program-detail__stats{grid-template-columns:repeat(3,minmax(0,1fr));gap:8px;max-width:none}.program-detail__body{padding-top:18px}.program-detail__stat{min-height:auto;padding:12px 10px;border-radius:16px}.program-detail__stat strong{font-size:.88rem}.program-detail__stat span{font-size:.54rem;letter-spacing:.08em}.program-detail__panel,.program-detail__sidecard,.program-detail__contact-card{padding:18px 16px;border-radius:24px}.program-detail__fact{padding:14px 16px}.program-detail__related-media{flex-basis:190px;height:190px}}
    </style>
