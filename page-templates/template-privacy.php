  ...
  <div class="inner">
    <div style="max-width: 1000px; margin: 0 auto;">
      ...
      $default_sections = array(
        ...
        array('title' => 'Your Rights and Choices', 'content' => '<p style="margin-bottom: 14px;">You have the right to access, correct, delete, opt-out of marketing communications, and request data portability. Contact us at info@mycohio.org to exercise these rights.</p>'),
